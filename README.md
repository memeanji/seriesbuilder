...
`VIDEO_ONLY_CBO` 모드에서는 모든 광고가 동영상 광고로 생성됩니다. 구조는 캠페인 1개, 광고세트 1개로 고정되며 Streamlit에서는 광고 개수만 선택합니다. 캠페인명, 캠페인 예산, 영상 파일 폴더, 광고별 랜딩 URL을 입력합니다.
...
`IMAGE_ONLY_CBO` 모드에서는 모든 광고가 이미지 광고로 생성됩니다. 구조는 캠페인 1개, 광고세트 1개로 고정되며 Streamlit에서는 광고 개수만 선택합니다. 캠페인명, 캠페인 예산, 이미지 파일 폴더, 광고별 랜딩 URL을 입력합니다.
...
실행 전 preview에는 캠페인명, 캠페인 예산, 광고세트명, 광고명 목록, 소재 파일 경로, 광고별 랜딩 URL이 표시됩니다. 소재 파일 또는 URL 누락이 있으면 실제 자동화 실행을 막습니다.
